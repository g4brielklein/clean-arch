...
export class RideRepositoryDatabase implements RideRepository {
    ...
    async saveRide(ride: Ride): Promise<void> {
        await this.connection.query({
            ...
            values: [ride.getRideId(), ride.getPassengerId(), ride.getDriverId(), ride.fromLat, ride.fromLong, ride.toLat, ride.toLong, ride.getFare(), ride.getDistance(), ride.getStatus(), ride.date],
        });
    };
